...
class Post extends Model
{
    ...
    public static function getPopArticle(){
        return DB::table('rainlab_blog_posts')
        ->select('vdomah_blogviews_views.views as view','vdomah_blogviews_views.post_id as post_id','rainlab_blog_posts.title as title')
        ->leftjoin('vdomah_blogviews_views','rainlab_blog_posts.id','=','vdomah_blogviews_views.post_id')
        ->orderBy('vdomah_blogviews_views.views','desc')
        ->take(6)
        ->get();
    }
}
